...
<button class="hanging-btn" id="seelessBtn">MORE + </button>
<!-- <span class="text-left">Please, visit the online version of <a href="http://cv.lux-exchange.com/dmitriy_shreyder_cv_pm_eng.html" target="_blank">my CV here --&gt;</a></span> -->

<p class="section-title_2">Key skills:</p>
<details open>
    <summary class="summary">PM & Web Developer</summary>
    <ul>
        <li>PM Methodology: <b>Agile</b>/KANBAN</li>
